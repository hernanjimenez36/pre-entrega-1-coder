...
# en el siguiente analisis sobre defunciones viales, trabaje con un archivo csv, intentando mostratr la cantidad de defunciones viales por municiopio,la distribuion de accidentes por clase de victima,una distribucion de las edades de las victimas,relacion entre la edad y el numero de victimas,y la evolucion de incidentes por horario
